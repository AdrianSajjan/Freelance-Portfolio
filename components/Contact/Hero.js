      ...
      <Container>
        <Row>
          ...
          <Column className="overlay">
            <div className="card">
              <h1 className="title">Reach out to me and I will reply you back by mail.</h1>
              <p className="subtitle">
                Use the form below or use my email to send me a mail. It will be my priority to get back to you.
              </p>
              <p className="subtitle">
                It's against my ethics to keep anyone in the dark and I'll help you with whatever technical problem you are
                facing.
              </p>
            </div>
          </Column>
