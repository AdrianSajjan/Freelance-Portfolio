      ...
      <Container>
        <Row>
          ...
          <Column className="overlay">
            <div className="card">
              <h1 className="title">This section is coming soon.</h1>
              <p className="subtitle">I am still designing my portfolio. It will be a matter of time before this link is live.</p>
              <p className="subtitle">
                Please bear with me as it will not dissapoint you. This section will showcase all my works and projects.
              </p>
            </div>
          </Column>
